...
include 'php-ofc-library/open-flash-chart.php';
	...
	$user_name = $_REQUEST['name'];
      ...
      $query = mysql_query("SELECT * FROM `facebook_status` WHERE from_id='$user_id' AND created_time LIKE '%2013-01-07%'") or die(mysql_error());
      $result1 = mysql_num_rows($query);
      $query = mysql_query("SELECT * FROM `facebook_status` WHERE from_id='$user_id' AND created_time LIKE '%2013-01-08%'") or die(mysql_error());
      $result2 = mysql_num_rows($query);
      $query = mysql_query("SELECT * FROM `facebook_status` WHERE from_id='$user_id' AND created_time LIKE '%2013-01-09%'") or die(mysql_error());
      $result3 = mysql_num_rows($query);
      $query = mysql_query("SELECT * FROM `facebook_status` WHERE from_id='$user_id' AND created_time LIKE '%2013-01-10%'") or die(mysql_error());
      $result4 = mysql_num_rows($query);
      $query = mysql_query("SELECT * FROM `facebook_status` WHERE from_id='$user_id' AND created_time LIKE '%2013-01-11%'") or die(mysql_error());
      $result5 = mysql_num_rows($query);
      $query = mysql_query("SELECT * FROM `facebook_status` WHERE from_id='$user_id' AND created_time LIKE '%2013-01-12%'") or die(mysql_error());
      $result6 = mysql_num_rows($query);
      $query = mysql_query("SELECT * FROM `facebook_status` WHERE from_id='$user_id' AND created_time LIKE '%2013-01-13%'") or die(mysql_error());
